...
def get_start_beep_html():
    ...
    return f"""<script>
        (function() {{
            const a = new Audio("data:audio/wav;base64,{start_b64}");
            a.volume = 0.8;
            a.play().catch(e => console.log("Start beep failed:", e));
        }})();
    </script>"""
...
def get_chime_html():
    ...
    return f"""<script>
        (function() {{
            const a = new Audio("data:audio/wav;base64,{end_b64}");
            a.volume = 0.8;
            a.play().catch(e => console.log("Chime failed:", e));
        }})();
    </script>"""
